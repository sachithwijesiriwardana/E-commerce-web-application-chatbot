...
<head>
  ...
  <title>Omantha Tyre Management System</title>
  <!-- chance the size of width -->
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                        <label>Appoinetment Number</label>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label>E-mail</label>
                        <input type="text" class="form-control" name="gender" value="<?php  echo $row['E-mail'];?>" readonly>
                    </div>

                    <div class="form-group">
                        <label>Tyre brand</label>
                        <input type="text" class="form-control" name="buildingno" id="buildingno" value="<?php  echo $row['Tyre brand'];?>" readonly>
                    </div>
